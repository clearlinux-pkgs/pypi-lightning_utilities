...
Version  : 0.11.6
Release  : 12
URL      : https://files.pythonhosted.org/packages/a3/af/2966ca3b3af2dc6b231a3a60ec84200724884e5767d7c10253840af41dfd/lightning_utilities-0.11.6.tar.gz
Source0  : https://files.pythonhosted.org/packages/a3/af/2966ca3b3af2dc6b231a3a60ec84200724884e5767d7c10253840af41dfd/lightning_utilities-0.11.6.tar.gz
...
%prep
%setup -q -n lightning_utilities-0.11.6
cd %{_builddir}/lightning_utilities-0.11.6
pushd ..
cp -a lightning_utilities-0.11.6 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1721772531
