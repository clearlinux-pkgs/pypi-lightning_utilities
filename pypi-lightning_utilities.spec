...
Source0  : https://files.pythonhosted.org/packages/27/11/869a3de9da0919b8b2179e9b2a6b0d9cd095baa2600f5c1f8744f398c049/lightning-utilities-0.8.0.tar.gz
...
%prep
%setup -q -n lightning-utilities-0.8.0
cd %{_builddir}/lightning-utilities-0.8.0
pushd ..
cp -a lightning-utilities-0.8.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1678901035
