...
Version  : 0.11.7
Release  : 13
URL      : https://files.pythonhosted.org/packages/d3/4c/5cb6b6bedc7564591b0ba1ffd3d5a9697d77248bc9da959503fec6fcf3cb/lightning_utilities-0.11.7.tar.gz
Source0  : https://files.pythonhosted.org/packages/d3/4c/5cb6b6bedc7564591b0ba1ffd3d5a9697d77248bc9da959503fec6fcf3cb/lightning_utilities-0.11.7.tar.gz
...
%prep
%setup -q -n lightning_utilities-0.11.7
cd %{_builddir}/lightning_utilities-0.11.7
pushd ..
cp -a lightning_utilities-0.11.7 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1725329003
