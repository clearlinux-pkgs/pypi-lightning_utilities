...
Version  : 0.10.1
Release  : 6
URL      : https://files.pythonhosted.org/packages/21/4e/1e0fe9eeeb4394310663d9f7e42b9cff88ecc8d36d1d201bdc31ab57d48b/lightning-utilities-0.10.1.tar.gz
Source0  : https://files.pythonhosted.org/packages/21/4e/1e0fe9eeeb4394310663d9f7e42b9cff88ecc8d36d1d201bdc31ab57d48b/lightning-utilities-0.10.1.tar.gz
...
%prep
%setup -q -n lightning-utilities-0.10.1
cd %{_builddir}/lightning-utilities-0.10.1
pushd ..
cp -a lightning-utilities-0.10.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1705702446
