...
Version  : 0.11.5
Release  : 11
URL      : https://files.pythonhosted.org/packages/d4/af/dba1228d9e273d2b6594506782ab66fee22ff577adae92a245e08f10ea33/lightning_utilities-0.11.5.tar.gz
Source0  : https://files.pythonhosted.org/packages/d4/af/dba1228d9e273d2b6594506782ab66fee22ff577adae92a245e08f10ea33/lightning_utilities-0.11.5.tar.gz
...
%prep
%setup -q -n lightning_utilities-0.11.5
cd %{_builddir}/lightning_utilities-0.11.5
pushd ..
cp -a lightning_utilities-0.11.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1721061947
