...
Version  : 0.11.0
Release  : 7
URL      : https://files.pythonhosted.org/packages/cd/d3/9766e02fe5a45333a2e8788c8c31d7b7e3e253a07b7aadb292f40fd1ab05/lightning-utilities-0.11.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/cd/d3/9766e02fe5a45333a2e8788c8c31d7b7e3e253a07b7aadb292f40fd1ab05/lightning-utilities-0.11.0.tar.gz
...
%prep
%setup -q -n lightning-utilities-0.11.0
cd %{_builddir}/lightning-utilities-0.11.0
pushd ..
cp -a lightning-utilities-0.11.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1710858627
