...
Release  : 10
URL      : https://files.pythonhosted.org/packages/ce/34/d74d2a24aa8eebf878662b358160dcdd390811e87e001a893dbbfcb97b6a/lightning_utilities-0.11.3.post0.tar.gz
Source0  : https://files.pythonhosted.org/packages/ce/34/d74d2a24aa8eebf878662b358160dcdd390811e87e001a893dbbfcb97b6a/lightning_utilities-0.11.3.post0.tar.gz
...
%prep
%setup -q -n lightning_utilities-0.11.3.post0
cd %{_builddir}/lightning_utilities-0.11.3.post0
pushd ..
cp -a lightning_utilities-0.11.3.post0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1719417293
